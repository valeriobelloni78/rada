...
const GUIDA = {
  ...
  it: {
    ...
    "g.tes2": "Anche qui i periodi sono coprimi a due a due, con una precisazione: sono numeri primi da diciannove in su, quindi coprimi anche con quelli delle frasi. Le linee che non tornano mai insieme sono otto, non due gruppi da quattro.",
    ...
    "g.tf5": "Ogni tessuto è fatto di due sinusoidi appena scordate, e la loro differenza in hertz è la pulsazione che si sente. È tutta la vita che serve a un suono che deve restare fermo a lungo.",
    "g.lbl.tmoods": "Gli otto tessuti",
    "g.tmoods.intro": "Come per le frasi, ogni mood è una configurazione completa. Due cose però restano fuori dai cursori: quanti tessuti per giro e quanto stanno sotto alle gocce sono il carattere del preset, non una manopola.",
    ...
    "g.tm.bordone": "Tre per giro molto sovrapposti: la trama non si interrompe mai.",
    ...
    "g.tm.radice": "Meno di un'ottava, tutta in basso, e il livello più alto degli otto.",
    "g.tm.vetrata": "Battito quasi doppio degli altri e affioramento rapido: il più inquieto.",
    "g.tm.marea": "Un tessuto solo per giro, che può durare fino a cinquanta secondi.",
    "g.tmt.velo": "4,5 giorni",
    "g.tmt.fondale": "15,8 giorni",
    "g.tmt.bordone": "5,8 giorni",
    "g.tmt.respiro": "13,6 giorni",
    "g.tmt.bruma": "26,8 giorni",
    "g.tmt.radice": "11,1 giorni",
    "g.tmt.vetrata": "17,9 giorni",
    "g.tmt.marea": "34,3 giorni",
  ...
  fr: {
    ...
    "g.tes2": "Ici aussi les périodes sont premières entre elles deux à deux, avec une précision~: ce sont des nombres premiers à partir de dix-neuf, donc premiers aussi avec ceux des phrases. Les lignes qui ne reviennent jamais ensemble sont huit, et non deux groupes de quatre.",
    ...
    "g.tf5": "Chaque tissu est fait de deux sinusoïdes à peine désaccordées, et leur écart en hertz est la pulsation que l'on entend. C'est toute la vie qu'il faut à un son qui doit rester immobile longtemps.",
    "g.lbl.tmoods": "Les huit tissus",
    "g.tmoods.intro": "Comme pour les phrases, chaque ambiance est une configuration complète. Deux choses restent pourtant hors des curseurs~: combien de tissus par tour et à quel point ils se tiennent sous les gouttes sont le caractère du préréglage, pas une molette.",
    ...
    "g.tm.bordone": "Trois par tour très superposés~: la trame ne s'interrompt jamais.",
    ...
    "g.tm.radice": "Moins d'une octave, tout en bas, et le niveau le plus haut des huit.",
    "g.tm.vetrata": "Battement presque double des autres et émergence rapide~: le plus inquiet.",
    "g.tm.marea": "Un seul tissu par tour, qui peut durer jusqu'à cinquante secondes.",
    "g.tmt.velo": "4,5 jours",
    "g.tmt.fondale": "15,8 jours",
    "g.tmt.bordone": "5,8 jours",
    "g.tmt.respiro": "13,6 jours",
    "g.tmt.bruma": "26,8 jours",
    "g.tmt.radice": "11,1 jours",
    "g.tmt.vetrata": "17,9 jours",
    "g.tmt.marea": "34,3 jours",
  ...
  en: {
    ...
    "g.tes2": "Here too the periods are pairwise coprime, with one refinement: they are prime numbers from nineteen upwards, and so coprime with the phrases' periods as well. The lines that never come back together are eight, not two groups of four.",
    ...
    "g.tf5": "Each weave is two barely detuned sine waves, and their distance in hertz is the pulsation you hear. It is all the life a sound needs when it has to stay still for a long time.",
    ...
    "g.tm.bordone": "Three per turn, heavily overlapped: the fabric never breaks.",
    ...
    "g.tm.radice": "Less than an octave, all of it low, and the highest level of the eight.",
    "g.tm.vetrata": "Beating almost twice as fast as the others and a quick surfacing: the most restless.",
    "g.tm.marea": "A single weave per turn, which can last up to fifty seconds.",
    "g.tmt.velo": "4.5 days",
    "g.tmt.fondale": "15.8 days",
    "g.tmt.bordone": "5.8 days",
    "g.tmt.respiro": "13.6 days",
    "g.tmt.bruma": "26.8 days",
    "g.tmt.radice": "11.1 days",
    "g.tmt.vetrata": "17.9 days",
    "g.tmt.marea": "34.3 days",
  ...
  ja: {
    ...
    "g.tes2": "ここでも周期は二つずつ互いに素ですが、ひとつ条件が加わります。十九以上の素数だけを使うので、フレーズの周期とも互いに素になります。二度と同じ組み合わせに戻らない線は、四つが二組ではなく、八本です。",
    ...
    "g.tf5": "どの織りもわずかに調子のずれた二つの正弦波でできていて、その差のヘルツがそのまま聞こえるうなりになります。長くとどまる音に必要な生命は、それだけです。",
    "g.lbl.tmoods": "八つの織り",
    "g.tmoods.intro": "フレーズと同じく、どのムードも完全な設定です。ただし二つだけスライダーの外に残ります。一周あたりいくつ織るか、滴に対してどれだけ下に置くか——それはムードの性格であって、つまみではありません。",
    "g.tm.velo": "出発点の均衡。中庸の音域、重なりは一をわずかに超える程度。",
    "g.tm.fondale": "一周にひと層だけ、きわめて長く低い。八つのなかでもっとも動かない。",
    "g.tm.bordone": "一周に三つ、深く重なりあう。織り目は途切れません。",
    "g.tm.respiro": "広い音域と、一を下回る重なり。織りと織りのあいだに沈黙が残ります。",
    "g.tm.bruma": "もっとも高く、もっとも淡い。広がりは三オクターヴ近く。",
    "g.tm.radice": "一オクターヴに満たず、すべて低域に。八つのなかで最も高い音量。",
    "g.tm.vetrata": "うなりは他のほぼ倍、立ち上がりも速い。もっとも落ち着かない。",
    "g.tm.marea": "一周にひとつだけ。五十秒に及ぶこともあります。",
    "g.tmt.velo": "4.5日",
    "g.tmt.fondale": "15.8日",
    "g.tmt.bordone": "5.8日",
    "g.tmt.respiro": "13.6日",
