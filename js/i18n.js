...
const STRINGS = {
  ...
  it: {
    ...
    "err.noCanvas":     "Il disegno non è disponibile: p5.js non è stato caricato. Il suono funziona lo stesso.",
  ...
  fr: {
    ...
    "err.noCanvas":     "Le dessin est indisponible : p5.js n'a pas été chargé. Le son fonctionne quand même.",
  ...
  en: {
    ...
    "err.noCanvas":     "The drawing is unavailable: p5.js did not load. The sound still works.",
  ...
  ja: {
    ...
    "err.noCanvas":     "描画を利用できません。p5.jsが読み込まれませんでした。音はそのまま鳴ります。",
