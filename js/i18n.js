...
const STRINGS = {
  ...
  it: {
    ...
    "err.noCanvas":     "Il disegno non è disponibile: p5.js non è stato caricato. Il suono e i comandi funzionano lo stesso.",
    ...
    mood: { sereno: "Sereno", pioggia: "Pioggia", vespro: "Vespro", carillon: "Carillon",
        ...
        droneMood: { velo: "Velo", fondale: "Fondale", bordone: "Bordone", respiro: "Respiro",
                 bruma: "Bruma", radice: "Radice", vetrata: "Vetrata", marea: "Marea" },
  ...
  fr: {
    ...
    "err.noCanvas":     "Le dessin est indisponible : p5.js n'a pas été chargé. Le son et les commandes fonctionnent quand même.",
    ...
    mood: { sereno: "Serein", pioggia: "Pluie", vespro: "Vêpres", carillon: "Carillon",
        ...
        droneMood: { velo: "Voile", fondale: "Fond", bordone: "Bourdon", respiro: "Souffle",
                 bruma: "Brume", radice: "Racine", vetrata: "Vitrail", marea: "Marée" },
  ...
  en: {
    ...
    "err.noCanvas":     "The drawing is unavailable: p5.js did not load. The sound and the controls still work.",
    ...
    mood: { sereno: "Clear", pioggia: "Rain", vespro: "Vespers", carillon: "Carillon",
        ...
        droneMood: { velo: "Veil", fondale: "Backdrop", bordone: "Bourdon", respiro: "Breath",
                 bruma: "Haze", radice: "Root", vetrata: "Glasswork", marea: "Tide" },
  ...
  ja: {
    ...
    "err.noCanvas":     "描画を利用できません。p5.jsが読み込まれませんでした。音も操作もそのまま働きます。",
    "media.artist":     "生成的な楽器",
    ...
    mood: { sereno: "凪", pioggia: "雨", vespro: "晩鐘", carillon: "風鈴",
        ...
        droneMood: { velo: "薄衣", fondale: "底", bordone: "通奏", respiro: "息",
                 bruma: "靄", radice: "根", vetrata: "硝子", marea: "潮" },
